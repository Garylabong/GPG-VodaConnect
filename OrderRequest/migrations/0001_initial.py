# Generated by Django 3.2 on 2021-04-27 23:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_code', models.CharField(blank=True, max_length=150, null=True, verbose_name='PREFERRED AREA CODE')),
                ...
                ('plan_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='OrderRequest.typeofplan', verbose_name='Type Of Plan')),
            ],
        ),
    ]
